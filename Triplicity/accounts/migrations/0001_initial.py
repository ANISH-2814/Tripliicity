    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_destinations', models.TextField(blank=True, help_text='Comma-separated list', null=True)),
                ('travel_interests', models.TextField(blank=True, help_text='Comma-separated list', null=True)),
